...
SEC_FLOATING_FEATURE_BATTERY_SUPPORT_LONGLIFE_OPTION=TRUE
...
SEC_FLOATING_FEATURE_GRAPHICS_SUPPORT_GAMEBOOSTER_MANUAL_ROUTINE=TRUE
...
SEC_FLOATING_FEATURE_MMFW_CONFIG_SMART_MIRRORING_PACKAGE_NAME=com.samsung.android.smartmirroring
...
APPLY_TARGET_FEATURE()
{
    ...
    if [ ! -f "$TARGET_FILE" ]; then
        if [ -f "$FW_DIR/$TARGET_FIRMWARE_PATH/system/etc/floating_feature.xml" ]; then
            TARGET_FILE="$FW_DIR/$TARGET_FIRMWARE_PATH/system/etc/floating_feature.xml"
        elif [ -f "$FW_DIR/$TARGET_FIRMWARE_PATH/vendor/etc/floating_feature.xml" ]; then
            TARGET_FILE="$FW_DIR/$TARGET_FIRMWARE_PATH/vendor/etc/floating_feature.xml"
        fi
    fi
