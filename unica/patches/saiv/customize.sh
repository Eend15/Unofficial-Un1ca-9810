...
TARGET_FLOATING_FEATURE_FILE="$FW_DIR/$TARGET_FIRMWARE_PATH/system/system/etc/floating_feature.xml"
if [ ! -f "$TARGET_FLOATING_FEATURE_FILE" ]; then
    if [ -f "$FW_DIR/$TARGET_FIRMWARE_PATH/system/etc/floating_feature.xml" ]; then
        TARGET_FLOATING_FEATURE_FILE="$FW_DIR/$TARGET_FIRMWARE_PATH/system/etc/floating_feature.xml"
    elif [ -f "$FW_DIR/$TARGET_FIRMWARE_PATH/vendor/etc/floating_feature.xml" ]; then
        TARGET_FLOATING_FEATURE_FILE="$FW_DIR/$TARGET_FIRMWARE_PATH/vendor/etc/floating_feature.xml"
    fi
fi

GET_TARGET_FLOATING_FEATURE_CONFIG()
{
    if [ -f "$TARGET_FLOATING_FEATURE_FILE" ]; then
        GET_FLOATING_FEATURE_CONFIG "$TARGET_FLOATING_FEATURE_FILE" "$1"
    fi
}
...
TARGET_VISION_CONFIG_FACE_RECOGNITION_SOLUTION="$(GET_TARGET_FLOATING_FEATURE_CONFIG "SEC_FLOATING_FEATURE_GALLERY_CONFIG_FACE_CLUSTER_VERSION")"
...
TARGET_GALLERY_CONFIG_IMAGE_TAGGER_VERSION="$(GET_TARGET_FLOATING_FEATURE_CONFIG "SEC_FLOATING_FEATURE_GALLERY_CONFIG_IMAGE_TAGGER_VERSION")"
...
TARGET_GALLERY_CONFIG_PET_CLUSTER_VERSION="$(GET_TARGET_FLOATING_FEATURE_CONFIG "SEC_FLOATING_FEATURE_GALLERY_CONFIG_PET_CLUSTER_VERSION")"
...
TARGET_CAMERA_CONFIG_DOCUMENT_DEWARP_VERSION="$(GET_TARGET_FLOATING_FEATURE_CONFIG "SEC_FLOATING_FEATURE_CAMERA_DOCUMENTSCAN_SOLUTIONS")"
...
unset SOURCE_FIRMWARE_PATH TARGET_FIRMWARE_PATH TARGET_FLOATING_FEATURE_FILE \
...
unset -f GET_TARGET_FLOATING_FEATURE_CONFIG
