...
# Keep the SpriteWallpaper build paired with the S22 One UI 8 framework.
# Updating this privileged app independently from Galaxy Store changes its
# internal wallpaper-service contract and crashes the apply flow on this port.
LOG "- Keeping the S22 One UI 8 Samsung Wallpaper app from the source firmware"
